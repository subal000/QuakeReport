    ...
    public static ArrayList<EarthquakeData> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0;i<earthquakeArray.length();i++){
                JSONObject currentEq = earthquakeArray.getJSONObject(i);
                JSONObject properties = (JSONObject) currentEq.get("properties");
                ...
                EarthquakeData earthquake = new EarthquakeData(magnitude, location, dateToDisplay);
